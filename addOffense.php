<?php  
    ...
    //get data from students_info table using primary key(info_id) to retrieve the lrn and name and show it in the form
    if($_SERVER['REQUEST_METHOD'] == 'GET'){
        ...
        //store in variable the data from the database
        $name = $row["name"];
        $lrn = $row["lrn"];
    }
    //add the data from the form to the students_offense table
    else{
        $lrn = $_POST["lrn"];
        $date = $_POST["date"];
        ...
        echo "<script>alert('Offense has been added successfully!')</script>";
...
<head>
    ...
    <link rel="stylesheet" href="styleAddOffense.css?v=<?php echo time(); ?>">
            ...
            <div class="bottom">
                ...
                <div class="content">
                    <div class="content_Top">
                        <i class="fa-solid fa-users">&nbsp;&nbsp;Manage&nbsp; Students&nbsp; -&nbsp; Add Offense</i>
                    </div>
                    <div class="content_Body">
                        <form method="post">
                            ...
                            <button type="submit" id="btn_AddOffense">Add Offense</button>
                        </form>
                    </div>
                </div>
            </div>
